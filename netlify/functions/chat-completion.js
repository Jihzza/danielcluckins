...
exports.handler = async (event) => {
  ...
  try {
    if (type === 'kickoff') {
      ...
      return { statusCode: 200, body: JSON.stringify({ success: true, content, usage: completion.usage }) };
    }
    ...
    return { statusCode: 500, body: JSON.stringify({ success: false, error: friendly }) };
  }
};
