...
export async function callFunction(functionName, payload) {
  // In development, skip network calls to Netlify functions since they don't exist locally
  // The calling code should handle fallbacks appropriately
  if (import.meta.env.DEV) {
    throw new Error('Netlify functions not available in development mode');
  }
