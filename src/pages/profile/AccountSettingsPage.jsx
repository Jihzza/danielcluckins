...
export default function SettingsPage() {
  ...
  return (
    <main className="min-h-[85vh] bg-[#002147]">
      <div className="mx-auto w-full max-w-6xl px-4 py-8 sm:py-10 md:py-12">
        <header className="mb-6 md:mb-8">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight text-[#fff] text-center">
